...
opts.Add(BoolVariable("use_sse42", "Use up to SSE4.2 code optimization", False))
opts.Add(BoolVariable("use_avx", "Use up to AVX code optimization", False))
opts.Add(BoolVariable("use_avx2", "Use up to AVX2 code optimization", False))
opts.Add(BoolVariable("use_avx512", "Use up to AVX512 code optimization", False))
opts.Add(BoolVariable("use_libcpp", "Enable use of llvm-project's libc++", False))
opts.Add(BoolVariable("use_compiler_rt", "Enable use of llvm-project's compiler-rt", False))
opts.Add(BoolVariable("use_lld", "Enable use of llvm-project's lld", False))
...
if selected_platform in platform_list:
    ...
    # SIMD instructions optimization levels environment logic expansion
    if env["use_avx512"]:
        env["use_sse42"] = True
        env["use_avx"] = True
        env["use_avx2"] = True
    ...
    if not env.msvc:
        if env["use_avx512"]:
            env.Prepend(CFLAGS=["-msse2", "-mxsave", "-msse3", "-mssse3", "-msse4.1", "-msse4.2", "-mpopcnt", "-mavx", "-mfma", "-mavx2", "-mlzcnt", "-mbmi2", "-mavx512f", "-mavx512dq"])
            env.Prepend(CXXFLAGS=["-msse2", "-mxsave", "-msse3", "-mssse3", "-msse4.1", "-msse4.2", "-mpopcnt", "-mavx", "-mfma", "-mavx2", "-mlzcnt", "-mbmi2", "-mavx512f", "-mavx512dq"])
        elif env["use_avx2"]:
            env.Prepend(CFLAGS=["-msse2", "-mxsave", "-msse3", "-mssse3", "-msse4.1", "-msse4.2", "-mpopcnt", "-mavx", "-mfma", "-mavx2", "-mlzcnt", "-mbmi2"])
            env.Prepend(CXXFLAGS=["-msse2", "-mxsave", "-msse3", "-mssse3", "-msse4.1", "-msse4.2", "-mpopcnt", "-mavx", "-mfma", "-mavx2", "-mlzcnt", "-mbmi2"])
        elif env["use_avx"]:
            env.Prepend(CFLAGS=["-msse2", "-mxsave", "-msse3", "-mssse3", "-msse4.1", "-msse4.2", "-mpopcnt", "-mavx", "-mfma"])
            env.Prepend(CXXFLAGS=["-msse2", "-mxsave", "-msse3", "-mssse3", "-msse4.1", "-msse4.2", "-mpopcnt", "-mavx", "-mfma"])
        elif env["use_sse42"]:
